...
public abstract class BaseDeDatos<R extends Registro<R, C>, C extends Enum> {
    ...
    public void modificaRegistro(R registro1, R registro2) {
        if (registro1 == null || registro2 == null)  throw new  IllegalArgumentException("El registro no puede ser null");
        int i = registros.indiceDe(registro1);
        if (i == -1) return;
        notificaEscuchas(EventoBaseDeDatos.REGISTRO_MODIFICADO, registro1, registro2);
    ...
    public void carga(BufferedReader in) throws IOException {
        ...
        while(((l = in.readLine()) != null) && (!(l.trim().isEmpty())) ){
            ...
            try {
                ...
                throw new IOException("La línea '"+l+ "'' es inválida");
            }
        }
    }
    ...
    private void notificaEscuchas(EventoBaseDeDatos e, R r1, R r2){
