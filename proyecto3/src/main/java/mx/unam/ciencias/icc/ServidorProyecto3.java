...
/**
 * ServidorProyecto3: Parte del servidor para la práctica 10: Hilos de
...
public class ServidorProyecto3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ServidorBaseDeDatosSismos servidor;
            servidor = new ServidorBaseDeDatosSismos(puerto, archivo);
