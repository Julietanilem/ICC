...
public class Aplicacion extends Application {
    ...
    /* Vista de la interfaz sismos. */
    private static final String INTERFAZ_SISMOS_FXML =
        "fxml/interfaz-sismos.fxml";
    ...
    @Override public void start(Stage escenario) throws Exception {
        ...
        escenario.setTitle("Administrador de Sismos");

        FXMLLoader cargador;
        cargador = new FXMLLoader(cl.getResource(INTERFAZ_SISMOS_FXML));
        BorderPane cristal = (BorderPane)cargador.load();
        ControladorInterfazSismos controlador = cargador.getController();
